export default {
    messages: {
        ...
        home: {
            ...
            fifth_regulationA: "Feel safe in the knowledge that our activities fall under the scope of AU legislation. CoinByte is a Registered Financial Services Provider.",
