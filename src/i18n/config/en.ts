export default {
    messages: {
        ...
        home: {
            ...
            step1_cont: "Find CoinbyteP2P's advertisement and place your order, your crypto asset will be escrowed by the Exchange",
            step2_cont: "Complete our verification through our website",
            step3_cont: "Check the transaction record in the given payment account, and make sure you receive the money sent by CoinbyteP2P.",
            step4_cont: "Once you confirm the receipt of money, release crypto to the CoinbyteP2P.",
